...
import yfinance as yf # builds the app and allows for integration
...
def display_question(question, index):
    ...
    # creating an options variable - helps us make specific criteria for the questions based on emotions
